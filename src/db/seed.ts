...
async function seed() {
  ...
  const districtsList = [
    ...
    "Ilaga", "Ilaga Utara", "Kembru", "Lambewi", "Mabugi",
    "Mage'abume", "Ogamanim", "Omukia", "Oneri", "Pogoma",
    "Sinak", "Sinak Barat", "Wangbe", "Yugumuak"
  ];

  const masterDistrictsData = districtsList.map(name => ({
    id: generateId(),
    name,
    code: `DST-${name.substring(0, 3).toUpperCase()}`,
  }));
  ...
  const servicesData = [
    {
      ...
      image: "/uploads/pemeriksaan-ibu-hamil-1771777497906-tssp65.jpg",
      location: "Poli KIA",
    ...
    },
    {
      ...
      category: "Kesehatan Ibu & Anak",
      categoryId: categoryMap.get("Kesehatan Ibu & Anak"),
      image: "/uploads/imunisasi-anak-1771777575591-6mwq34.jpg",
      location: "Poli Anak",
    ...
    },
    {
      ...
      image: "/uploads/gizi-1771777542292-rbs2sa.jpg",
      location: "Poli Gizi",
    ...
    },
    {
      ...
      image: "/uploads/lansia-1771777561237-9dadz6.jpg",
...
<p>Masyarakat diharapkan membawa KMS (Kartu Menuju Sehat) dan buku KIA saat mengunjungi Posyandu.</p>`,
      ...
      image: "/uploads/posyandu-1771777800293-bkfktc.jpg",
...
<p>Lakukan 3M Plus untuk mencegah demam berdarah: Menguras, Menutup, dan Mendaur ulang barang bekas.</p>`,
      category: "Kesehatan",
      image: "/uploads/bg-login-1771777898684-u9fiiu.jpg",
...
<li>Anak dalam kondisi sehat</li>
      ...
      category: "Program",
      image: "/uploads/imunisasi-1771777913782-00i8o9.jpg",
      author: "Tim Promkes",
      status: "published" as const,
      unitKerjaId: ilagaUnitKerja?.id,
...
<li>Pemantauan tumbuh kembang rutin</li>
      ...
      category: "Edukasi",
      image: "/uploads/stunting-1771777933323-t51w2c.jpg",
      author: "Ahli Gizi",
      status: "published" as const,
      unitKerjaId: ilagaUnitKerja?.id,
  ...
  const programsData = [
    {
      ...
      icon: "Baby",
      image: "/uploads/posyandu-1771778135260-0gs0aj.jpg",
      participants: 1250,
      target: 1500,
    ...
    },
    {
      ...
      category: "Gizi",
      icon: "TrendingUp",
      image: "/uploads/stunting-program-1771778180326-ccf76p.jpg",
      participants: 320,
      target: 400,
      startDate: new Date("2024-01-01"),
      endDate: new Date("2024-12-31"),
    ...
    },
    {
      ...
      category: "Imunisasi",
      icon: "Shield",
      image: "/uploads/imunisasi-anak-1771778160314-cilte8.jpg",
      participants: 890,
      target: 1000,
      startDate: new Date("2024-01-01"),
      endDate: new Date("2024-12-31"),
    ...
    },
    {
      ...
      icon: "Heart",
      image: "/uploads/program-prolanis-1771778195895-pgq4un.jpg",
      participants: 450,
      target: 500,
      startDate: new Date("2024-01-01"),
      endDate: new Date("2024-12-31"),
    ...
    },
    {
      ...
      icon: "Brain",
      image: "/uploads/kesehatan-jiwa-1771778205508-falzz4.jpg",
      participants: 85,
      target: 150,
      startDate: new Date("2024-01-01"),
      endDate: new Date("2024-12-31"),
    ...
    },
    {
      ...
      icon: "Users",
      image: "/uploads/germas-1771778225853-u8wwuv.jpg",
      participants: 2100,
      target: 3000,
      startDate: new Date("2024-01-01"),
      endDate: new Date("2024-12-31"),
